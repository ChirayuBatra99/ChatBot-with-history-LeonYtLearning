...
print(x)
chain= chaine(x)
st.write("Ask any question based on the provided documents.")

if 'chat_history' not in st.session_state:
    st.session_state.chat_history = []
msj = st.text_input("Enter your message:")

if st.button("Send"):
    if msj:
        response = process_chat(chain, msj, st.session_state.chat_history)
        st.session_state.chat_history.append(HumanMessage(content=msj))
